...
//            switchButton.isHidden = true
    ...
    @objc private func suaThongTinPhong() {
        let suaPhong = DatabaseModel.getInstance().suaThongTinPhong(tenPhong: tenphongTF.text!, ngayDat: ngaydatTF.text!, tienPhong: Int(tienphongTF.text!)!, soNguoi: Int(songuoiTF.text!)!, ngayThanhToan: ngaythanhtoanTF.text!, idPhong: idPhong!)
    ...
    private func configureUI() {
        ...
        let constraints = [
            ...
            nguoidatLB.topAnchor.constraint(equalTo: tenphongTF.bottomAnchor, constant: 24),
            nguoidatLB.leftAnchor.constraint(equalTo: tenphongTF.leftAnchor),
